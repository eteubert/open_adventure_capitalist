defmodule OpenAdventureCapitalist.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: OpenAdventureCapitalist.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    OpenAdventureCapitalistWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
